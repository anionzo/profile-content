...
Ba năm rưỡi làm nghề dạy mình điều này sớm hơn mình chịu nghe. Site cá nhân chỉ là chỗ mình chịu nghe muộn.

## Trước đây

Mọi thứ cứng trong component. Menu, tên, tagline, cả danh sách việc. Muốn đổi chức danh cho khớp hợp đồng là phải đụng source, mở nhánh, chờ xem trước.
...
Một file giữ tên, chức danh, câu dưới tên. Một file giữ việc ở IDX HUIT. Một file giữ cử nhân 2020–2024 và thạc sĩ đang học. Bài viết là Markdown, có trạng thái nháp hoặc ra.
...
Một lối là làm portfolio cho có: một kho, chữ trộn code, đưa lên một lần rồi quên.

Lối kia là coi nó như hệ thống nhỏ: khuôn dữ liệu, đồng bộ, bài nháp, RSS. Mất thêm một buổi. Lần sau sửa chữ không phải nhớ component nào.
